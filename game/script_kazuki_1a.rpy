...
label Kazuki_1b:
    ...
    nnvlmc "Despite this, there is neither the feeling of pain nor the sensation of bliss. I merely exist, and wander through the fog. Fog so thick that I could drink it..."
    extend " Pain can only last for so long. The hatred that I have felt would have killed a weaker man."
    nnvlmc "...I don't understand love. I have never experienced it, and I cannot recognise it."
    extend " Perhaps I had once known how to love, and love well. But those that I was capable of loving have since left me."
    nnvlmc "Even so, I live. For what else am I to do but join the world in its cycle? The tumultuous and chaotic cycle in which there is no true chain of command."
    nnvlmc "Left, and right. Left, and right. Despite my qualms, these uncovered feet of mine take me forwards."
    extend " Towards where, as always, is a matter of negligible significance. He who wanders is he who is wayward."
    ...
    nnvlmc "I walk past an hazy image of my family. I could not see it, except for in my mind."
    ...
    nvls "Return."
    nnvlmc "And then the darkness covered my eyes once more, and I was returned to the world of the living..."
    scene bg fakefog
    nvl clear
    #]
